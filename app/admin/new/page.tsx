...
export default async function NewToolPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto py-12">
      <h1 className="type-title mb-8">Add New Tool</h1>
      ...
      <form action={createTool} className="space-y-6">
        ...
        <div>
          ...
          <input name="logo" type="file" accept="image/*" required className="type-caption mt-1 block w-full text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:font-semibold file:bg-black file:text-white hover:file:bg-gray-800"/>
        </div>

        <button type="submit" className="type-body w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-white bg-black hover:bg-gray-800">
            Create Tool
        </button>
      </form>
    </div>
